...
def parse_transfers(html_soup, transfer_date):
    ...
    for transfer_soup in transfers_soups:
        ...
        transfers.append({
            'portrait_url': portrait_url if portrait_url else '',
            ...
            'left_club_league_country_url': left_club_league_country_url if left_club_league_country_url else '',
            'left_club_league_country_name': left_club_league_country_name if left_club_league_country_name else '',
            'left_club_league_name': left_club_league_name if left_club_league_name else '',
            'left_club_league_name_alt': left_club_league_name_alt if left_club_league_name_alt else '',
            'join_club_url': join_club_url if join_club_url else '',
            'join_club_name': join_club_name if join_club_name else '',
            'join_club_name_alt': join_club_name_alt if join_club_name_alt else '',
            'join_club_league_country_url': join_club_league_country_url if join_club_league_country_url else '',
            'join_club_league_country_name': join_club_league_country_name if join_club_league_country_name else '',
            'join_club_league_name': join_club_league_name if join_club_league_name else '',
            'join_club_league_name_alt': join_club_league_name_alt if join_club_league_name_alt else '',
            'market_value': market_value if market_value else '',
            'fee': fee if fee else '',
            'loan_fee': loan_fee if loan_fee else '',
            'transfer_url': transfer_url if transfer_url else '',
